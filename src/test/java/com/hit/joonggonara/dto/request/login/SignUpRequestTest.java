...
class SignUpRequestTest {
    ...
    static Stream<Arguments> signUpValidationTest() {
        return Stream.of(
                Arguments.of(null, "principal@nave.com", "Abc1234567*", "name", "nickName", "010-0000-0000", USER_ID_NOT_BLANK),
                Arguments.of("testId", null, "Abc1234567*", "name", "nickName", "010-0000-0000", EMAIL_NOT_BLANK),
                Arguments.of("testId","principal", "Abc1234567*", "name", "nickName", "010-0000-0000", EMAIL),
                Arguments.of("testId","principal@nave.com", null, "name", "nickName", "010-0000-0000", PASSWORD_NOT_BLANK),
                Arguments.of("testId","principal@nave.com", "abc", "name", "nickName", "010-0000-0000", PASSWORD_PATTERN),
                Arguments.of("testId","principal@nave.com", "Abc1234567*", null, "nickName", "010-0000-0000",NAME_NOT_BLANK),
                Arguments.of("testId","principal@nave.com", "Abc1234567*", "name", null, "010-0000-0000", NICK_NAME_NOT_BLANK),
                Arguments.of("testId","principal@nave.com", "Abc1234567*", "name", "nickName", null, PHONE_NUMBER_NOT_BLANK)
        );
    }
